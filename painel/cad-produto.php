            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h1 class="page-title"> DeliveryUP.
                        <small>Aqui você poderá cadastrar seus produtos</small>
                    </h1>
                    <div class="page-bar">
                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green bold uppercase">Cadastro de Produtos</span>
                                    </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group  margin-top-15">
                                                <div class="container">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <label><b>Imagem Principal</b>
                                                                <span class="required"> * </span></label>
                                                            <input type="file" name="principal" class="form-control">
                                                        </div>
                                                        <div class="col-md-5">
                                                            <label>Outras Imagens</label>
                                                            <input type="file" name="img[]" multiple="multiple" max="6" class="form-control" id="exampleFormControlFile1">
                                                        </div>
                                                        <br>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <button type="submit" name="enviar" class="btn green">Cadastrar</button>
