...
<html lang="en">
    <head>
        <title>Dashboard DeliveryUp.</title>
                        ...
                        <div class="col-sm-12">
                            <section class="row">
                                <div class="col-md-12 col-lg-8">
                                    <div class="jumbotron">
                                        <center><h1 class="mb-4">Bem Vindo, <?= $emp_nome ?></h1>

                                            <p class="lead">Você possui pedido pendente.</p>

                                            <h3>2</h3>

                                            <p class="lead"><a class="btn btn-primary btn-lg mt-2" href="#" role="button">Visualizar</a></p>
                                        </center>
                                    </div>

                                    <div class="card mb-4">
                                        <div class="card-block">
                                            <h3 class="card-title">Pedidos Completado no mês</h3>
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="card mb-4">
                                        <div class="card-block">
                                            <h3 class="card-title">Top Pedidos</h3>

                                            <h6 class="card-subtitle mb-2 text-muted">Os mais pedidos do mês</h6>
